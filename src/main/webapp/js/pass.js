...
function check() {
    ...
    if (department.value == "" || uname.value == "" || studentId.value == "" || testDay.value == "" || applyTime.value == "" || expireTime.value == "") {
        msg.innerHTML = "请填写完整信息";
        return false;
    }

    if (studentId.value.length != 11 || isNaN(studentId.value) || studentId.value <= 0) {
